...
export default app => {
  ...
  router.get('/admin_demo_api/blog/getTag', app.admin.blog.getTag)
  router.post('/admin_demo_api/blog/addTag', app.admin.blog.addTag)
  router.post('/admin_demo_api/blog/update', app.admin.blog.update)
  router.get('/admin_demo_api/blog/del', app.admin.blog.del)
  router.get('/admin_demo_api/blog/deleteTag', app.admin.blog.deleteTag)
